     ...
     <form className="form-block" onSubmit={submitHandler}>
       <div className='form-block__inp'>
          ...
          <div>
            ...
            <span className='not-read-books-count'>Not Read: {readBooks.length}</span>
          </div>
        </div>
        <div className='btns-block'>
          <button className='form-btn btn-add' type='submit'>Add book</button>
          <button className='form-btn btn-remove' onClick={removeAll}>Delete all</button>
        </div>
